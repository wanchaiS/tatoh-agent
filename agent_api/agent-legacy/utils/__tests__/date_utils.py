...
def test_format_consecutive_dates():
    assert format_date_ranges(["2026-11-02", "2026-11-03", "2026-11-04"]) == [
        "2026-11-02 to 2026-11-04"
    ]


def test_format_non_consecutive_dates():
    assert format_date_ranges(["2026-11-02", "2026-11-04", "2026-11-08"]) == [
        "2026-11-02",
        "2026-11-04",
        "2026-11-08",
    ]
...
def test_format_unsorted_input():
    ...
    assert format_date_ranges(["2026-11-04", "2026-11-02", "2026-11-03"]) == [
        "2026-11-02 to 2026-11-04"
    ]
